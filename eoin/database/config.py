...
import json
import uuid
from os.path import dirname, abspath, join, normpath, exists, isfile, basename
...
path_conf = dirname(kywd['PG_config'])
conf_main = basename(kywd['PG_config'])
...
def autoselect(match_text=None, import_list=[], all_records=False, help_text=True):
